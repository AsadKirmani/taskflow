...
export class UiToggleComponent {
  ...
  computedToggleClasses = computed(() => {
    const base =
      'relative rounded-full transition-colors duration-200 ease-in-out bg-base-300 peer-focus:ring-2 peer-focus:ring-primary/20 peer-checked:bg-primary after:content-[""] after:absolute after:bg-base-100 after:border after:border-base-300/10 after:rounded-full after:transition-all after:duration-200 peer-checked:after:border-base-100';
