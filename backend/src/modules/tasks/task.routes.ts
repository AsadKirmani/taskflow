...
router.post('/tasks/:taskId/attachments', authMiddleware, uploadMiddleware.single('file'), asyncHandler(taskController.addAttachment));

router.delete('/tasks/:taskId/attachments', authMiddleware, asyncHandler(taskController.removeAttachment));
